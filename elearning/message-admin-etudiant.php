...
<center style="font-weight:bold;font-size:13pt;color:white;">Message aux &eacute;tudiants</center><br> 
<form action="enregistrer-message-admin-etudiant.php" method="post" id="sendemail" enctype="multipart/form-data">
