...
//
//
echo "<br/><br/><center style='font-weight:bold;font-size:13pt;color:white;'>LISTE DES MESSAGES ENVOYES AUX ENSEIGNANTS</center><br/><br/>";
...
$pass = "";
              try
              {
			   ...
			   m.id_destinataire=e.id_enseignant and m.type_expediteur like 'etu%' and m.type_destinataire like 'ens%'  and m.id_expediteur= :ide  order by m.date desc;");
