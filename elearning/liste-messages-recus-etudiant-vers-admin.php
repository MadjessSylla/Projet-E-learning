...
$pass = "";
              try
              {
               ...
               //
               $res=$pdo->query("select m.*,e.nom_etudiant,e.prenom_etudiant from message m, etudiant e, user u where 
                                u.id_user=m.id_expediteur and u.id_user=e.id_user and m.type_expediteur like 'etu%' and m.type_destinataire like 'adm%'  order by m.date desc;");
