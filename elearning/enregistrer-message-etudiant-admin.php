...
//
  ...
  //
//
echo "<br/><br/><center>ENREGISTREMENT MESSAGE A L'ADMINISTRATION</center><br/><br/>";
...
try
{
 ...
 //
  ...
  $res = $pdo->prepare($sql);
  $exec = $res->execute(array(":dat"=>$date,":ob"=>$obj,":mes"=>$msg,":ide"=>$ida,":typex"=>"ETU",
  ":idd"=>"-99",":typed"=>"ADM",":pj"=>$fichier1));
  //
