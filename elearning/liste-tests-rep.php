...
?>
	<div class="container"  style="margin-top:20px;width:50%;float:clear;">
		<h4 style="text-align:center;color: white;">S&eacute;lection du Test pour la saisie de r&eacute;ponse/question</h4>
		<br/>   
          <?php
            //
			//Instanciation PDO
            ...
            try
            {
               ...
               //
                ...
                foreach($res as $ligne)
                {
					...
					<td><a href='ajout-reponse.php?it=$idt&te=$titre_test' target='_blank'>S&eacute;lectionner</a></td>
					</tr>";
                }
               echo "</table>";
               //
...
<style >
  body{
      background: linear-gradient(rgba(0,0,0,0.6),rgba(0,0,0,0.6)), url("pictures/mary4.jpg");
      height: 110vh;
      width: 100%;
