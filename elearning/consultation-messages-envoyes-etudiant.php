...
else
{
 ...
 ?>
<br/>
<center style="font-weight:bold;font-size:13pt;color:#069;">Liste des messages envoy&eacute;s aux &eacute;tudiants</center><br>
...
<table border="0" style="margin-top:10px;">
 ...
 // 
 $ctr=0;
 $sql="select * from message where type_expediteur='Administration' and type_destinataire='Etudiant' order by date desc; ";
  $rep=mysql_query($sql);
  //
