...
?>
	<div class="container"  style="margin-top:20px;width:50%;float:clear;color: black;">
		...
		<a href="passer-test.php?it=<?php echo $idt.'&te='.$titre; ?>" style="margin-left:80%;">Passer le test</a>
		<br/> 
...
<style >
  body{
      background: linear-gradient(rgba(0,0,0,0.6),rgba(0,0,0,0.6)), url("pictures/img1.jpg");
      height: 90vh;
      width: 100%;
