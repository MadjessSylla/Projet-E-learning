...
<center style="font-weight:bold;font-size:13pt;color:white;">Message aux enseignants</center><br> 
<form action="enregistrer-message-admin-enseignant.php" method="post" id="sendemail" enctype="multipart/form-data">
